...
OperationStatus operation_status_from_string(std::experimental::string_view status)
{
    if (status == "Ok")
    {
...
SignalStatus signal_status_from_string(std::experimental::string_view status)
{
    if (status == "OnAdd")
    {
